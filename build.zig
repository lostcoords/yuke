...
const native_js = "yuke:cancellation-native,yuke:diff,yuke:engine-native,yuke:env,yuke:exec,yuke:fs,yuke:hooks,yuke:interaction-native,yuke:jobs-native,yuke:net-native,yuke:process,yuke:term,yuke:tools";
