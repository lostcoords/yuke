...
const native_js = "yuke:cancellation-native,yuke:diff,yuke:engine-native,yuke:env,yuke:exec,yuke:fs,yuke:hooks,yuke:http-native,yuke:interaction-native,yuke:jobs-native,yuke:mcp-native,yuke:net-native,yuke:process,yuke:term,yuke:tools,yuke:utf8";
