//! The request IR stays neutral. `build` maps a transcript to flat blocks. Serializers read the IR instead of `proto.Message`.
...
pub const Block = struct {
    ...
    pub const Media = struct {
        source: proto.content.MediaSource,
    };
...
/// A provider request without the transcript. The engine assembles it per turn.
...
pub const Options = struct {
    ...
    target: ?proto.message.TurnProvenance = null,
};
