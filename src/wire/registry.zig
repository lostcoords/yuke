...
pub const structs = [_]TypeEntry{
    ...
    .{ .name = "AuthSetApiKeyResult", .ty = auth.AuthSetApiKeyResult },
    ...
    .{ .name = "CatalogHealth", .ty = catalog.CatalogHealth },
    ...
    .{ .name = "SkippedProvider", .ty = catalog.SkippedProvider },
    .{ .name = "SkipReasonInvalidConfig", .ty = catalog.SkipReasonInvalidConfig },
    .{ .name = "SkipReasonMissingCredential", .ty = catalog.SkipReasonMissingCredential },
