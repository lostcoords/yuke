...
import MessagePart = $engine_native.MessagePart;
import SessionOutline = $engine_native.SessionOutline;
...
import NavTarget = $types_core.NavTarget;
import NodeShape = $types_core.NodeShape;
...
import cancellation = $cancellation_native;
...
export type CancellationSignal = $cancellation_native.CancellationSignal;
export type Disposer = $types_ext.Disposer;
export type AdviceWhere = $types_ext.AdviceWhere;
export type AdviceOptions = $types_ext.AdviceOptions;
export type InteractionSurface = $types_ext.InteractionSurface;
export type InteractionOptions = $types_ext.InteractionOptions;
...
import ReadOptions = $http_native.ReadOptions;
class Headers {
    #private;
...
import native = $jobs_native;
import Job = $jobs_native.Job;
...
import Rect = $types_core.Rect;
import IntrinsicSize = $types_layout.IntrinsicSize;
import LayoutChild = $types_layout.LayoutChild;
import LayoutNode = $types_layout.LayoutNode;
...
import Plugin = $types_ext.Plugin;
import ServerConfig = $mcp_transport.ServerConfig;
...
import ConnectOptions = $net_native.ConnectOptions;
import Socket = $net_native.Socket;
export const net: {
...
export import fill = $core.fill;
export import copy = $core.copy;
export import quit = $core.quit;
export import ui = $ui.ui;
export import List = $ui.List;
export import Composer = $ui.Composer;
export import Text = $ui.Text;
export import Window = $ui.Window;
export import Picker = $ui.Picker;
export import Prompt = $ui.Prompt;
...
import ProcessExit = $process.ProcessExit;
...
import keymap = $core.keymap;
import route = $core.route;
...
import NavAction = $types_ui.NavAction;
import PickerAction = $types_ui.PickerAction;
import PickOptions = $types_ui.PickOptions;
import Projection = $types_ui.Projection;
import PromptOptions = $types_ui.PromptOptions;
import TextOptions = $types_ui.TextOptions;
...
import Color = $term.Color;
import Style = $term.Style;
...
declare namespace $engine_native {
...
declare namespace $types_layout {
import Rect = $types_core.Rect;
