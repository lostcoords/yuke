...
export interface AgentsSetModelParams {
...
export interface Methods {
  "agents.set_model": { paramsType: [AgentsSetModelParams]; returnType: SessionConfigResult };
  ...
  "agents.resolve": { paramsType: [AgentsResolveParams]; returnType: AgentsResolveResult };
  /** Establish the connection and negotiate the protocol version. */
  ...
  /** Update a session's mutable fields. */
  "session.patch": { paramsType: [SessionPatchParams]; returnType: SessionResult };
  /** Remove a session. */
  "session.remove": { paramsType: [SessionRemoveParams]; returnType: Empty };
  /** Fork a session at a message. */
  "session.fork": { paramsType: [SessionForkParams]; returnType: SessionResult };
  /** Compact a session's transcript. */
