...
export type MethodName = "initialize" | "session.list" | "session.get" | "session.create" | "session.patch" | "session.remove" | "session.fork" | "session.compact" | "session.rewind" | "session.send_input" | "session.cancel_input" | "session.queue" | "session.cancel_run" | "session.history" | "session.config" | "catalog.list" | "catalog.reload" | "auth.list" | "auth.set_api_key" | "auth.login" | "auth.cancel_login" | "auth.remove" | "interaction.respond" | "skill.list";
...
export type RequestParams = SessionListParams | SessionGetParams | CreateSession | SessionPatchParams | SessionRemoveParams | SessionForkParams | SessionCompactParams | SessionRewindParams | SessionSendInputParams | SessionCancelInputParams | SessionQueueParams | SessionCancelRunParams | SessionHistoryParams | SessionConfigParams | CatalogListParams | Empty | AuthSetApiKeyParams | AuthLoginParams | AuthCancelLoginParams | AuthRemoveParams | InteractionRespondParams;

export type ResponseResult = InitializeResult | SessionListResult | SessionListItem | SessionResult | Empty | SessionCompactResult | SessionSendInputResult | SessionCancelInputResult | SessionQueueResult | SessionCancelRunResult | SessionHistoryResult | SessionConfigResult | CatalogListResult | CatalogReloadResult | AuthListResult | AuthLoginResult;
