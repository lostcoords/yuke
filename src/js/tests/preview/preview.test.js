...
check("report-source", sourceSpan(t.sourceOf("report"), reportRows, "report-line-0"));
...
check("plain-source", sourceSpan(t.sourceOf("answer"), toolRows, "plain-line-0"));
...
check("reasoning-source", sourceSpan(t.sourceOf("answer"), reasoningRows, "reason-first") && sourceSpan(t.sourceOf("answer"), reasoningRows, "reason-last"));
