...
const bad = [
  ...
  [{ catalog: { a: {} }, maxRounds: 0 }, "maxRounds must be"], [{ catalog: { a: {} }, maxDepth: 1.5 }, "maxDepth must be"], [{ catalog: { a: {} }, nope: 1 }, "unknown option nope"],
];
const failures = [];
...
const pair = agents({ default: "b", catalog: { a: {}, b: { tools: ["read"] } }, maxRounds: 3 });
