...
check("active-expanded", t.rows(40, t.globalRow({ id: "live", row: 0, col: 0 }), 5).some((r) => r.kind === "reasoning-body"));
const rebuilt = [];
const rowsOf = t.rowsOf;
t.rowsOf = function(m, w, i) { rebuilt.push(String(m.id)); return rowsOf.call(this, m, w, i); };
...
check("draft-collapsed", t.rowCountOf("live") < liveCount && !t.rows(40, t.globalRow({ id: "live", row: 0, col: 0 }), 4).some((r) => r.kind === "reasoning-body"));
